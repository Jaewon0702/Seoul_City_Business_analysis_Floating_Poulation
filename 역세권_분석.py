...
print(
    "%s에서 승차인원이 가장 많을 때는 %d시 %d명이고, 가장 적을 때는 %d시  %d명입니다,"
    % (station, maxtime_in, max_in, mintime_in, min_in)
)
print(
    "%s에서 하차인원이 가장 많을 때는 %d시 %d명이고, 가장 적을 때는 %d시  %d명입니다,"
    % (station, maxtime_out, max_out, mintime_out, min_in)
)
print(
    "%s에서 유동인구가 가장 많을 때는 %d시 %d명이고, 가장 적을 때는 %d시  %d명입니다,"
    % (station, smaxtime, max_sub, smintime, min_sub)
)
